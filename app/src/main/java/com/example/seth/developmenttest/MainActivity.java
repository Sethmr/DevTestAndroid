...
public class MainActivity extends Service implements LocationListener {
    ...
    public Location getLocation() {
        try {
            ...
            isGPSEndabled = locationManager.isProviderEnabled(locationManager.GPS_PROVIDER);

            isNetworkEnabled = locationManager.isProviderEnabled(LocationManager.NETWORK_PROVIDER);

            if(!isGPSEndabled && !isNetworkEnabled) {
    ...
    public void stopUsingGPS() {
        if(locationManager != null) {
            try { locationManager.removeUpdates(MainActivity.this); }
            catch (SecurityException e) { e.printStackTrace(); }
        }
    }
